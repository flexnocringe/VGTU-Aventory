      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-6">
        <header className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
          <div>
            ...
            <p className="text-sm text-slate-600">Overview of stock levels, product snapshots, and profit analytics.</p>
          </div>
          <a href="/products" className="rounded-lg bg-slate-900 px-4 py-2 text-white transition hover:bg-slate-800">
            View All Products
          </a>
        </header>
